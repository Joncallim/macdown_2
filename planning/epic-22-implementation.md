...
- **Slice 3a** — Foundation: `selectionSet`/computed `selectedRange`, selection-set-aware selection-change handling, Escape-collapse, multi-range typing/delete/paste via `EditorEditTransaction` (§6.9).
- **Slice 3b** — Native interactions: Option-click add/remove, Add/Remove Cursor Above/Below, rectangular/Option-drag selection (§6.9), once 3a is merged and proven.
