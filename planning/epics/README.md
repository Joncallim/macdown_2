...
| E19 | First-class math and scientific notation | M5 — feature completion | E10, E12, E14 | ✅ done (issue #44; PR #61 + PR #62 merged, `e12ee9b`). The nested-code-fence adversarial case was run for real: Export's gap was found and fixed; Preview's analogous gap was found, characterized, and filed as [#63](https://github.com/Joncallim/macdown_2/issues/63) (P2, not fixed here — needs its own scoped design pass). Residual release-evidence debt (large-equation Release perf measurement, live visual re-check of the post-#62 fixes) tracked in `RELEASE_EVIDENCE.md` |
| E20 | Native diagram platform + Mermaid | M5 — feature completion | E12, E14 | ✅ done (issue #45; PRs #74-#78). Real, non-mocked automated evidence throughout package and app-integration levels; UI-test execution and live visual dogfood remain open, blocked by this session's environment, tracked in `RELEASE_EVIDENCE.md` |
| E21 | Evaluate/integrate D2, Graphviz/DOT, WaveDrom | M5 — feature completion | E20 | 🔶 in progress — issue #46. D2 and Graphviz ACCEPTED and wired through Export + native Preview (Slices 1-4, PRs #81-#84); WaveDrom DEFERRED (disclosed `eval()`/CVE finding, not rejected). Slices 5 (adversarial hardening) and 6 (Definition of Done) remain; see `RELEASE_EVIDENCE.md` |
