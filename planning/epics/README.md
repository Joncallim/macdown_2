...
| E14 | Renderer-neutral first-party contributions + text filters | M5 — feature completion | E07, E12 export contract | 🟡 partial (issue #15; PR #54): contribution SPI/registry, the TOC contribution, and Preview/Export integration shipped, with a 10-finding adversarial-review remediation. User text-filter commands + command-palette integration are **not** in #54 — tracked as a follow-up ("E14B") before E19 starts, per E14's own dependency on E19 below |
