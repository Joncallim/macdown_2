...
`formats/export/settings → E14 contribution infrastructure → E19 math → E20 diagram platform + Mermaid → E21 renderer admission/integration → feature-complete gate → E15 whole-app polish/first-run → E16 translation infrastructure/current baseline → E22 editor essentials → public identity re-freeze → E23 Mac integration & personalisation → affected E15 evidence delta → final E16 localisation/string freeze → E17 migration/distribution`
...
| E17 | Stateful migration, distribution & release | M5 — polish & ship | E22/E23 + affected E15 evidence + final E16 freeze | open |
...
E19 + E21 + remaining original Mac features
  ...
  ─▶ affected E15 release-evidence delta
