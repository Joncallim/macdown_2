...
`core/editor work → formats/export/settings → E14 contribution infrastructure → E19 math → E20 diagram platform + Mermaid → E21 engineering diagrams → feature-complete gate → E15 whole-app polish → E16 localisation → E17 distribution`
...
| E06 | Markdown engine | M3 — Markdown core | E01 | open/planned; reconcile against live repo before implementation |
| E07 | Native preview (Textual) | M3 — Markdown core | E06, E04 | open/planned; reconcile against live repo before implementation |
| E08 | Content browser (document outline) | M3 — Markdown core | E06, E02 | open/planned; reconcile against live repo before implementation |
| E09 | Folder browser | M4 — Workspace & formats | E01, E02, E03 | ✅ done |
| E10 | Editing assists | M2 — Editor | E04 | implemented on epic branch; see architecture/PR evidence |
| E11 | Multi-format: JSON & HTML + language registry | M4 — Workspace & formats | E05, E07 | open |
...
| E19 | First-class math and scientific notation | M5 — feature completion | E10, E12, E14 | open |
| E20 | Native diagram platform + Mermaid | M5 — feature completion | E12, E14 | open |
| E21 | Technical diagrams: D2, Graphviz/DOT, WaveDrom | M5 — feature completion | E20 | open |
...
| E16 | Localization | M5 — polish & ship | stable strings after feature completion | open |
| E17 | Distribution & release | M5 — polish & ship | all macOS 1.0 work | open |
| E18 | Live external-file changes | M4 — Workspace & formats | E01, E03 (as built), E04 | implemented locally; hosted CI and sustained dogfooding remain proof gates |
...
The exact critical path must be recalculated from live repository state when an epic architecture pass starts; the diagram above is roadmap ordering, not permission to ignore already-shipped dependencies.
...
- Each implementation architecture records its exact baseline SHA and reconciles the issue against live `master`.
